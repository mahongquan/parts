...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox.currentIndexChanged['int'].connect(Form.selectpack)
        self.pushButton_deletepack.clicked.connect(Form.deletepack)
        self.comboBox_2.currentIndexChanged['int'].connect(Form.selectitem)
        ...
        self.comboBox.editTextChanged['QString'].connect(Form.packinput)
