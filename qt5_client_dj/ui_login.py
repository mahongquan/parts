...
#
# Created by: PySide2 UI code generator 5.5.1
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lineEdit_username.setText(_translate("Dialog", "mahongquan"))
        self.label_2.setText(_translate("Dialog", "TextLabel"))
        self.lineEdit_password.setText(_translate("Dialog", "333333"))
