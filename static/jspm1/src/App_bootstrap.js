...
class App extends Component {
  ...
  <td>
        <input type="text" value={this.state.search}  placeholder="合同 or 仪器编号" onChange={(e)=>this.handleSearchChange(e)} />
        <button id="id_bt_search" className="btm btn-info" onClick={(e)=>this.search(e)}>搜索
