...
export default function PackItemEditNew(props){
  ...
  const quehuoChange = e => {
    dispatch(store.actions.PackItemEdit_QUE_CHANGE({name:e.target.name,value:e.target.value}));
  };
  const handleChange = e => {
    dispatch(store.actions.PackItemEdit_CHANGE({name:e.target.name,value:e.target.value}));
  };
