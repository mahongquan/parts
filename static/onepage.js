...
Ext.define('Contact', {
    ...
    , 'yonghu', 'addr','channels','yiqixinghao','yiqibh','baoxiang','shenhe',{name:'yujifahuo_date',type:"date",dateFormat: 'Y-m-d'},'hetongbh',{name:'tiaoshi_date',type:"date",dateFormat: 'Y-m-d'}],
    // validators: {
    //     yiqibh: {
    //         type: 'length',
    //         min: 1
