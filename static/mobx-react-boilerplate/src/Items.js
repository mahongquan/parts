          ...
          <table id="table_input" className="table-condensed">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input
                    style={{ backgroundColor: this.props.store.bg.name }}
                    type="text"
                    id="name"
                    name="name"
                    value={this.props.store.packitem.name}
              ...
              <tr>
                ...
                <td>
                  <input
                    style={{ backgroundColor: this.props.store.bg.guige }}
                    type="text"
                    name="guige"
                    value={this.props.store.packitem.guige}
                    onChange={this.handleChange}
                  />
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input
                    style={{ backgroundColor: this.props.store.bg.bh }}
                    type="text"
                    id="bh"
                    name="bh"
                    value={this.props.store.packitem.bh}
                    onChange={this.handleChange}
                  />
                </td>
              </tr>
    ...
    return (
      <div>
        ...
        <Table responsive bordered condensed>
          ...
          <tbody id="item-list">{itemRows}</tbody>
        </Table>
        {prev}
        <label id="page">
