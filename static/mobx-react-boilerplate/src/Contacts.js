...
export default class Contacts extends Component {
  ...
  handleNext = e => {
    ...
    if (
      ...
      this.props.store.total - this.props.store.limit
    ) {
  ...
  render = () => {
    ...
    if (
      this.props.store.start + this.props.store.limit >=
      ...
      <div id="todoapp" className="table-responsive">
        <div style={{ display: 'flex', alignItems: 'center' }}>
          ...
          <button
            className="btn btn-info"
            onClick={() => {
              this.props.store.showDlgImport = true;
            }}
          >
            导入标样
          </button>
        ...
        <table className="table-condensed table-bordered">
          ...
          <tbody id="contact-list">{itemRows}</tbody>
        </table>
        {prev}
        <label id="page">
          {this.props.store.start + 1}../{this.props.store.total}
        </label>
        {next}
        <input
          maxLength="6"
          ...
          value={this.props.store.start_input}
        />
        ...
        <DlgLogin
          showModal={this.props.store.showDlgLogin}
        ...
        <DlgDetail
          ...
          showModal={this.props.store.showDlgDetail}
          handleClose={() => {
        ...
        <DlgImport
          showModal={this.props.store.showDlgImport}
          handleClose={() => {
            this.props.store.showDlgImport = false;
          }}
        />
        <DlgUrl
          showModal={this.props.store.showDlgUrl}
        ...
        />
        <DlgFolder
          showModal={this.props.store.showDlgFolder}
          contactid={this.props.store.contactid}
          handleClose={() => {
        ...
        />
        <DlgCheck
          showModal={this.props.store.showDlgCheck}
          contactid={this.props.store.contactid}
        ...
        />
        <DlgWait
          showModal={this.props.store.showDlgWait}
          contactid={this.props.store.contactid}
          handleClose={() => {
