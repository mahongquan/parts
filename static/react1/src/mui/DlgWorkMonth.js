...
class DlgItems extends Component {
  ...
  loaddata = () => {
    ...
    let cmd="select * from parts_contact  where work_month IS NULL and baoxiang like '"+baoxiang+"'  and tiaoshi_date between '"+start_date_s+"' and '"+end_date_s+"'"
    Client.sql(cmd,
      contacts2 => {
    ...
    cmd2="select * from parts_contact  where strftime('%Y-%m',work_month)='"+current_str+"' and baoxiang like '"+baoxiang+"'  and tiaoshi_date between '"+start_date_s+"' and '"+end_date_s+"'"
    Client.sql(cmd2,
      contacts2 => {
        console.log(contacts2);
        this.setState({
  ...
  handleEdit = idx => {
    ...
    let cmd2;//strftime('%Y',tiaoshi_date) as month,count(id) as ct
    cmd2="update parts_contact set work_month='"+this.end_date_s+"' where id="+contact.id;
    Client.sql(cmd2,
      contacts2 => {
        console.log(contacts2);
        this.loaddata();
