...
var loadglobal=function(){
    myglobal.load_user_edit=function(){    
        ...
        var headers={}||store.proxy.headers;
            headers["X_CSRFTOKEN"]=myglobal.token;
    ...
    /////////////////////////////////////////////////////////////////////////
    myglobal.loadContactPack=function(contact){
        var pageSize1=10;
        ...
        var grid = Ext.create('Ext.grid.Panel', {
            ...
            dockedItems: [{
                ...
                items: [{
                    ...
                    iconCls: 'icon-add',
                    handler: function(){
                        selectContactPack(contact,store);
                    }
                }, '-', {
                    itemId: 'delete',
                    text: 'Delete',
        ...
        var grid = Ext.create('Ext.grid.Panel', {
                    ...
                    },
                {
                    ...
                    handler: function(){
                        var selection = grid.getView().getSelectionModel().getSelection()[0];
                        if (selection) {
                            selectContactItem(selection.data,store);
                        }
                    }
                }]
                }]
    ...
    var onContactPack=function(contact){//
        console.log("click");
        var helloWindow = new Ext.Window({
            x:0,y:90,width:600,height:400,
        });
        helloWindow.show('windowDiv');
        helloWindow.add(myglobal.loadContactPack(contact));
    }; 
    ...
    var selectContactItem=function(contact,store){
        ...
        helloWindow.show('windowDiv');
        helloWindow.add(myglobal.loadItem(store,contact,helloWindow));
    };
    var selectContactPack=function(contact,store){
        console.log("click");
        var helloWindow = new Ext.Window({
            x:0,y:90,width:600,height:400,modal:true,
        });
