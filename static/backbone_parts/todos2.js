...
$(function(){
  ...
  var Todo = Backbone.Model.extend({
    ...
    fields:["id","hetongbh","yonhu","addr","channels","yiqixinghao","yiqibh","baoxiang","shenhe","yujifahuo_date"],
    defaults: function() {
      var d=new Date();
      var dstr=d.getFullYear()+"-"+(d.getMonth()+1)+"-"+d.getDate();
      return {
        id:"",hetongbh:"",yonhu:"",addr:"",channels:"",yiqixinghao:"",yiqibh:"",baoxiang:"",shenhe:"",yujifahuo_date:dstr
      };
    }
  });
